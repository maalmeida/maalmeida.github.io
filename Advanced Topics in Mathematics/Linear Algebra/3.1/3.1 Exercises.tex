...
\begin{questions}
    ...
    %=============
    \uplevel{Compute the determinants in Exercises 9-14 by cofactor expansion. At each step, chooose a a row or column that minimizes the amount of computation}
